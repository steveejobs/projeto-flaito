-- FIX: hard_delete_client não pode referenciar tabela inexistente (sign_requests)
-- Nesta base, a tabela correta é public.document_sign_requests.
-- Também garantimos reativação de triggers mesmo se ocorrer erro.
