-- ============================================
-- FIX 1: Permissão de leitura no dicionário EPROC
-- ============================================

-- Garantir RLS habilitado
ALTER TABLE IF EXISTS public.nija_eproc_event_dictionary ENABLE ROW LEVEL SECURITY;

-- Remover política existente se houver
DROP POLICY IF EXISTS "nija_eproc_dict_select_authenticated" ON public.nija_eproc_event_dictionary;

-- Criar política de leitura pública para usuários autenticados (dicionário é público dentro do sistema)
...
-- ============================================
-- FIX 2: Garantir permissões na tabela nija_extractions
-- ============================================

-- Remover políticas antigas que podem estar com problemas
...
-- Recriar com subquery mais simples e performática
