-- Corrigir função hard_delete_client: documents usa case_id, não client_id
...
BEGIN
    ...
    -- Excluir documentos dos CASOS do cliente (documents usa case_id, não client_id)
    DELETE FROM public.document_sign_requests 
    WHERE document_id IN (
        SELECT d.id FROM public.documents d
        INNER JOIN public.cases c ON d.case_id = c.id
