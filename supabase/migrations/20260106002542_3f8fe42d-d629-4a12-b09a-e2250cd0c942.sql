-- Update CONTRATO template to use JavaScript DOM approach like PROC/DECL
...
<body>
  <div class="page">
    ...
    <div class="content">
      ...
      <p class="clausula-texto">
        <strong>CONTRATANTE:</strong> <span id="clientIdent"></span>
      </p>

      <p class="clausula-texto">
        <strong>CONTRATADO:</strong> <span id="officeRespName"></span>, advogado(a) inscrito(a) na
        <span id="officeRespOabFull"></span>, com escritório profissional em <span id="officeRespAddress"></span>.
      </p>
  ...
  <script>
    ...
    (function () {
      ...
      const oabNum = office.responsavel_oab || "";
      const oabUf = office.responsavel_oab_uf || "";
      setText($("officeRespOabFull"), "OAB/" + (oabUf || "UF") + " sob nº " + (oabNum || "—"));
      setText($("officeRespOabSign"), "OAB/" + oabUf + " " + oabNum);
      ...
      if (officeSignEl && has(office.signature_signed_url)) {
        ...
        const smh = Number(office.signature_max_height) || 80;
        const smw = Number(office.signature_max_width) || 200;
