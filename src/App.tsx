...
import { MedicalPatientProvider } from "@/contexts/MedicalPatientContext";
...
// Optimized QueryClient with better production defaults
              ...
              <OfficeBrandingProvider>
                <AppInitializer>
                  <Routes>
                    ...
                    {/* ====== MÓDULO JURÍDICO (PROTECTED + LAYOUT + CONTEXTS) ====== */}
                    <Route
                      element={
                        <ActiveClientProvider>
                          <MedicalPatientProvider>
                          <DevPanelProvider>
                            <VoiceAgentProvider>
                              <ChatContextProvider>
                                <LegalShell />
                    ...
                    >
                      <Route path="/dashboard" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><LegalDashboard /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/crm" element={<RoleProtectedRoute minRole="MEMBER"><CRMPage /></RoleProtectedRoute>} />
                      <Route path="/inbox" element={<RoleProtectedRoute minRole="MEMBER"><OperationsInbox /></RoleProtectedRoute>} />
                      <Route path="/agent-studio" element={<RoleProtectedRoute minRole="ADMIN"><AgentStudio /></RoleProtectedRoute>} />
                      ...
                      <Route path="/alerts" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><DeadlineAlerts /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/kpis" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><KpisPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/cases" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><Cases /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/documents" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><Documents /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/documents/print/:id" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><DocumentPrint /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/cases/payments" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><CasesPaymentsPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/cases/history" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><CasesHistoryPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/clientes" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><Clientes /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/agenda" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><Agenda /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/agenda/payments" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><AgendaPaymentsPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/agenda/history" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><AgendaHistoryPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/nija" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><Nija /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/nija/docs" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><NijaDocsPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/nija/research" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="LEGAL"><NijaResearchPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/nija/credits" element={<RoleProtectedRoute minRole="ADMIN"><ModuleProtectedRoute module="LEGAL"><NijaCreditsPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/document-types" element={<RoleProtectedRoute minRole="ADMIN"><DocumentTypes /></RoleProtectedRoute>} />
                      <Route path="/knowledge" element={<RoleProtectedRoute minRole="ADMIN"><Knowledge /></RoleProtectedRoute>} />
                      <Route path="/meu-escritorio" element={<RoleProtectedRoute minRole="MEMBER"><MeuEscritorio /></RoleProtectedRoute>} />
                      <Route path="/settings/office" element={<RoleProtectedRoute minRole="ADMIN"><OfficeSettings /></RoleProtectedRoute>} />
                      <Route path="/settings/members" element={<RoleProtectedRoute minRole="ADMIN"><OfficeMembers /></RoleProtectedRoute>} />
                      <Route path="/settings/profile" element={<RoleProtectedRoute minRole="MEMBER"><MemberProfile /></RoleProtectedRoute>} />
                      <Route path="/settings/voice-agent" element={<Navigate to="/agent-studio?slug=voice-assistant" replace />} />
                      <Route path="/sistema/aparencia" element={<RoleProtectedRoute minRole="ADMIN"><AparenciaPage /></RoleProtectedRoute>} />
                      <Route path="/reports" element={<RoleProtectedRoute minRole="ADMIN"><Reports /></RoleProtectedRoute>} />
                      <Route path="/nija-usage" element={<RoleProtectedRoute minRole="ADMIN"><NijaUsage /></RoleProtectedRoute>} />
                      ...
                      <Route path="/integrations" element={<RoleProtectedRoute minRole="ADMIN"><Integrations /></RoleProtectedRoute>} />
                      <Route path="/plaud-inbox" element={<RoleProtectedRoute minRole="MEMBER"><PlaudInbox /></RoleProtectedRoute>} />
                      <Route path="/admin/users" element={<RoleProtectedRoute minRole="OWNER"><AdminUsersPage /></RoleProtectedRoute>} />
                      <Route path="/admin/offices" element={<RoleProtectedRoute minRole="OWNER"><AdminOfficesPage /></RoleProtectedRoute>} />
                      <Route path="/admin/permissions" element={<RoleProtectedRoute minRole="OWNER"><AdminPermissionsPage /></RoleProtectedRoute>} />
                      <Route path="/admin/audit" element={<RoleProtectedRoute minRole="OWNER"><AdminAuditPage /></RoleProtectedRoute>} />
                      <Route path="/admin/tjto-dictionary" element={<RoleProtectedRoute minRole="ADMIN"><TjtoDictionaryAdmin /></RoleProtectedRoute>} />
                      <Route path="/admin/precedents" element={<RoleProtectedRoute minRole="OWNER"><PrecedentsAdmin /></RoleProtectedRoute>} />
                      <Route path="/admin/modelos" element={<RoleProtectedRoute minRole="ADMIN"><AdminModelos /></RoleProtectedRoute>} />
                      <Route path="/admin/captacao" element={<RoleProtectedRoute minRole="OWNER"><AdminCaptureQr /></RoleProtectedRoute>} />
                    ...
                    {/* ====== MÓDULO MÉDICO (PROTECTED + LAYOUT + CONTEXTS) ====== */}
                    <Route
                      element={
                        <ActiveClientProvider>
                          <MedicalPatientProvider>
                    ...
                    >
                      <Route path="/medical/agent-studio" element={<RoleProtectedRoute minRole="ADMIN"><AgentStudio /></RoleProtectedRoute>} />
                      <Route path="/medical/inbox" element={<RoleProtectedRoute minRole="MEMBER"><OperationsInbox /></RoleProtectedRoute>} />
                      <Route path="/medical/dashboard" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><MedicalDashboard /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/ia" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><DecifradorCasosPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/agenda" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><AgendaMedicaPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/patients" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><PacientesPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/patients/:id" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><PacienteDetalhe /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/atendimento/:id" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><AtendimentoMedicoPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/transcricao" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><TranscricaoPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/analise" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><AnaliseClinicaPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                      <Route path="/medical/protocolos" element={<RoleProtectedRoute minRole="MEMBER"><ModuleProtectedRoute module="MEDICAL"><ProtocolosPage /></ModuleProtectedRoute></RoleProtectedRoute>} />
                    </Route>
